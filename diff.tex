...
%DIF ADD out_new.tex   Mon Oct  9 10:47:41 2017
%% bare_jrnl.tex
%% V1.4b
%% 2015/08/26
%% by Michael Shell
...
\subsubsection{HRP-2 -- \DIFdelbegin \DIFdel{Steep staircase }\DIFdelend \DIFaddbegin \DIFadd{Staircase with high steps }\DIFaddend (Figure~\ref{fig:stair_robust})}
...
}\DIFdelend \DIFaddbegin \DIFadd{center-of-mass positions and velocities $\mathbf{c}(t)$, $\mathbf{\dot{c}}(t)$ are interval variables, obtained through the double integration of $\mathbf{\ddot{c}}(t)$.
