...
%~ Then, regarding the heuristics we used to generate contacts and solve \mP2, we believe that heuristics are somehow underestimated in robotics, where optimality principles are often preferred. This is not the case in other fields, like discrete optimization, data routing or multi-agent diagnosis in web applications.
...
First, our planner is good enough for the majority of situations that nowadays legged robot can meet.
...
&
%~ It was indeed difficult to fully feel the enthusiasm of the reviewer, although
