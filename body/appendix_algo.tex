\section{Algorithms for the discretization of a path}
\label{app:contact}
...
If \textsc{GenFullBody} failed in achieving this, the method \textsc{RepositionContacts} is called.
...
The pseudo code for the method \textsc{GenFullBody} is given by Algorithm~\ref{alg:pi}.
