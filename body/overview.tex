...
However, even verifying \glslink{contact feasible}{\textit{contact feasibility}} is computationally too expensive because it requires the projection of the whole-body configuration into a contact posture.
