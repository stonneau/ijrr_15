...
The first problem is \Pa, that consists in computing a guide path for the root of the robot that can be extended; the second problem is $\mathcal{P}_2$, that is the computation of a discrete sequence of contacts along the root path.
...
of the volumes $W^0$.
%
\textbf{Regarding performance}, our framework is really efficient in addressing both \Pa and $\mathcal{P}_2$. This results in computation costs close to real-time in
