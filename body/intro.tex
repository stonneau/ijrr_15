...
Finally, to demonstrate the validity of our approach regarding the complete chain, we show that the contact plans we produce can be successfully executed, either in simulation or on the real HRP-2 robot.
