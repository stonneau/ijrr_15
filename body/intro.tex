...
The relaxation is justified empirically, with statistics presented for each robot and scenario presented\adnote{several robots and scenario, or even better, for N robots and M scenarios}. The complete framework is implemented within
...
These candidates are sorted using a criterion to evaluate the static equilibrium of the configuration, and ranked according to user-defined heuristics.
