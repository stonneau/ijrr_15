...
on the existence of quasi-static equilibrium configurations along a feasible path, which is too restrictive in the general case.
...
As far as robotics applications are concerned, none of the existing planners is \gls{interactive}(We define an interactive planner as one that outputs a solution in a few seconds or less) . That is 
