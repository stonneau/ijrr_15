...
algorithm. Given start and goal configurations, it outputs a continuous path for the root of the robot. Thanks to the \textit{reachability condition}, we assume that any for any configuration in the path there exists a joint configuration that results in static equilibrium.
