...
In the simulations we controlled the robot with a standard inverse-dynamics controller~\cite{DelPrete2015b}. The code source of the simulator is available at \url{https://github.com/andreadelprete/pinocchio_inv_dyn/releases/tag/rbprm}.
...
column indicates the average time necessary to compute one contact transition. The Collision column times includes the (negligeable) octree intersection operation necessary to retrieve the candidate samples.}
