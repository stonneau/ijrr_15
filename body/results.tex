...
Few contributions provided computation times on the complete problem. To provide a completely fair comparison, it would be required to compare the methods on the same computers and exact same scenarios, which is not possible because the source code of the other methods is often not available. %, necessary to provide comparison between our approaches. 
