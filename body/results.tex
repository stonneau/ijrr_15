...
Similarly we computed the specificity of the condition (proportion of configurations \textbf{not} in $C_{Reach}^0$, effectively \textbf{not} belonging to \gls{$C_{Contact}^0$}).
...
As it can be expected, the scaling results in a high decrease of the sensitivity, with a decrease of the specificity.
...
On the other hand for HyQ most of the time is spent testing the static equilibrium of the candidates configurations..
