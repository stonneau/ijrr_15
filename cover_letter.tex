...
to compute the contact sequence that characterize a robot motion in
...
the method on an actual robot. We did not have the room to describe
this process in the conference paper, and explain the complete process
...
\item Regarding the performances, compared to our conference paper, the planner is much more efficient.
