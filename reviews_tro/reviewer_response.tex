...
The text appearing in \textcolor{blue} denotes the additions. We used the latexdiff tools to generate this file, which is not fully compatible with the latex math package.
For this reason, errors appear in the document, in particular regarding the subsections number. However, we think that this diff file will help the reviewers locate precisely
